...
export const DEBIT_NOTE_NOT_CREATE = "DEBIT_NOTE_NOT_CREATE";
export const DETAIL_DEBIT_NOTE_NOT_CREATE = "DETAIL_DEBIT_NOTE_NOT_CREATE";
export const ADD_PAYMENT_DEBIT = "ADD_PAYMENT_DEBIT";
export const DETAIL_DEBIT_NOTE = "DETAIL_DEBIT_NOTE";

export const LIST_PEDING_KH = "LIST_PEDING_KH";
export const LIST_PAID_KH = "LIST_PAID_KH";
export const APPROVE_KH = "APPROVE_KH";

export const LIST_JOBS_OF_CUSTOMER = "LIST_JOBS_OF_CUSTOMER";
