...
const ModalPaymentDebit = () => {
  ...
  const onFinish = (values) => {
    ...
    form.append("TRANS_FROM", values.ORDER_FROM);
    form.append("TRANS_TO", values.ORDER_TO);
    ...
    >
      ...
      >
        <Row gutter={24}>
          ...
          <Col span={8}>
            <Form.Item label="Debit Date" name="JOB_DATE">
              <Input disabled />
            </Form.Item>
          </Col>
          <Col span={4}>
...
export default ModalPaymentDebit;
